...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>After Promotion CCH</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">If it fails, the failure will be reported, but the deployment will not be stopped.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">The quality gate will be executed against the Promotion branch.</value>
    </values>
    <values>
